...
#     return new_dados_csv[0]
# '''
# def rename_columns(dados, key_mapping):
#     return [{key_mapping[old_key]: value for old_key, value in old_dict.items()} for old_dict in dados]
...
print(f'Nomes Colunas fusão: {nome_colunas_fusao}')
